...
## 9. Tabelas de Domínio (IPAGTD)

| Tabela | Domínio | Campo CNAB |
|--------|---------|-----------|
| `IPAGTD001_TIPO_REGISTRO` | Tipos de registro válidos: 0, 1, 2, 3, 4, 5, 9 | G003 |
| `IPAGTD002_TIPO_SERVICO` | Tipos de serviço/produto do lote (01=Cobrança, 20=Fornecedor, 30=Salário...) | G025 |
| `IPAGTD003_TIPO_OPERACAO` | Operação do lote: C=Crédito, D=Débito, E=Extrato | G028 |
| `IPAGTD004_TIPO_MOVIMENTO` | Natureza da instrução do detalhe: 0=Inclusão, 5=Alteração, 9=Exclusão | G060 |
| `IPAGTD005_TIPO_INSCRICAO` | Tipo de pessoa: 1=CPF, 2=CNPJ, 3=PIS/PASEP | G005 |
| `IPAGTD006_TIPO_MOEDA` | Moedas: BRL, USD, EUR, etc. | G040 |
| `IPAGTD007_CAMARA_CENTRAL` | Câmaras centralizadoras para roteamento de pagamentos (TED, PIX, DOC...) | P001 |
| `IPAGTD008_SERVICO_DESTINO` | Microsserviços consumidores dos lotes (Boleto, Pagamento, Tributo...) | — |
...
| TD001–TD008 | IPAGTD001 a IPAGTD008 | — | Domínios / Lookup |
