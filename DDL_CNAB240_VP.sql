...
CREATE TABLE IPAGTB027_DISPATCH_LOTE (
    ID_DISPATCH_LOTE        NUMBER,
    ID_LOTE                 NUMBER        NOT NULL,
    ID_SERVICO_DESTINO      NUMBER        NOT NULL,
    CO_STATUS_DISPATCH      VARCHAR2(20) NOT NULL,
...
--    a. Worker consulta IPAGTV002_DISPATCH_PENDENTE (SELECT FOR 
