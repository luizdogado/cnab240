...
-- ----------------------------------------------------------------------------
CREATE SEQUENCE IPAGTD001_TIPO_REGISTRO_SQ START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE IPAGTD001_TIPO_REGISTRO (
    ID_TIPO_REGISTRO       NUMBER          DEFAULT ON NULL IPAGTD001_TIPO_REGISTRO_SQ.NEXTVAL,
    ...
    CONSTRAINT IPAGTD001_TIPO_REGISTRO_PK   PRIMARY KEY (ID_TIPO_REGISTRO),
    CONSTRAINT IPAGTD001_TIPO_REGISTRO_UK01 UNIQUE (CO_TIPO_REGISTRO)
);

COMMENT ON TABLE IPAGTD001_TIPO_REGISTRO IS
...
COMMENT ON COLUMN IPAGTD001_TIPO_REGISTRO.ID_TIPO_REGISTRO     IS 'Identificador surrogate gerado por sequence. Chave primaria interna sem significado de negocio.';
COMMENT ON COLUMN IPAGTD001_TIPO_REGISTRO.CO_TIPO_REGISTRO     IS 'Codigo do tipo de registro conforme padrao CNAB240. Campo G003. Valores: 0,1,2,3,4,5,9.';
COMMENT ON COLUMN IPAGTD001_TIPO_REGISTRO.NO_TIPO_REGISTRO     IS 'Descricao por extenso do tipo de registro. Exemplo: Header de Arquivo.';
COMMENT ON COLUMN IPAGTD001_TIPO_REGISTRO.DH_INCLUSAO          IS 'Data e hora em que o registro foi incluido na tabela.';
COMMENT ON COLUMN IPAGTD001_TIPO_REGISTRO.DH_ALTERACAO         IS 'Data e hora da ultima alteracao do registro. Nulo se nunca alterado.';
COMMENT ON COLUMN IPAGTD001_TIPO_REGISTRO.NO_USUARIO_INCLUSAO  IS 'Login do usuario que incluiu o registro.';
COMMENT ON COLUMN IPAGTD001_TIPO_REGISTRO.NO_USUARIO_ALTERACAO IS 'Login do usuario que realizou a ultima alteracao. Nulo se nunca alterado.';

-- ----------------------------------------------------------------------------
-- IPAGTD002_TIPO_SERVICO
-- ----------------------------------------------------------------------------
CREATE SEQUENCE IPAGTD002_TIPO_SERVICO_SQ START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE IPAGTD002_TIPO_SERVICO (
    ID_TIPO_SERVICO        NUMBER          DEFAULT ON NULL IPAGTD002_TIPO_SERVICO_SQ.NEXTVAL,
    ...
    NO_USUARIO_INCLUSAO    VARCHAR2(60)    NOT NULL,
    NO_USUARIO_ALTERACAO   VARCHAR2(60),
    CONSTRAINT IPAGTD002_TIPO_SERVICO_PK   PRIMARY KEY (ID_TIPO_SERVICO),
    CONSTRAINT IPAGTD002_TIPO_SERVICO_UK01 UNIQUE (CO_TIPO_SERVICO)
);

COMMENT ON TABLE IPAGTD002_TIPO_SERVICO IS
...
COMMENT ON COLUMN IPAGTD002_TIPO_SERVICO.CO_TIPO_SERVICO IS 'Codigo de 2 digitos do tipo de servico. Campo G025. Exemplos: 01, 20, 22, 30, 98.';
COMMENT ON COLUMN IPAGTD002_TIPO_SERVICO.NO_TIPO_SERVICO IS 'Descricao do servico/produto. Exemplo: Pagamento de Fornecedores e Honorarios.';
COMMENT ON COLUMN IPAGTD002_TIPO_SERVICO.ID_TIPO_SERVICO IS 'Identificador surrogate gerado por sequence. Chave primaria interna.';
COMMENT ON COLUMN IPAGTD002_TIPO_SERVICO.DH_INCLUSAO          IS 'Data e hora de inclusao do registro.';
COMMENT ON COLUMN IPAGTD002_TIPO_SERVICO.DH_ALTERACAO         IS 'Data e hora da ultima alteracao.';
COMMENT ON COLUMN IPAGTD002_TIPO_SERVICO.NO_USUARIO_INCLUSAO  IS 'Login do usuario que incluiu.';
COMMENT ON COLUMN IPAGTD002_TIPO_SERVICO.NO_USUARIO_ALTERACAO IS 'Login do usuario que alterou.';

-- ----------------------------------------------------------------------------
-- IPAGTD003_TIPO_OPERACAO
-- ----------------------------------------------------------------------------
CREATE SEQUENCE IPAGTD003_TIPO_OPERACAO_SQ START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE IPAGTD003_TIPO_OPERACAO (
    ID_TIPO_OPERACAO       NUMBER          DEFAULT ON NULL IPAGTD003_TIPO_OPERACAO_SQ.NEXTVAL,
    ...
    NO_USUARIO_INCLUSAO    VARCHAR2(60)    NOT NULL,
    NO_USUARIO_ALTERACAO   VARCHAR2(60),
    CONSTRAINT IPAGTD003_TIPO_OPERACAO_PK   PRIMARY KEY (ID_TIPO_OPERACAO),
    CONSTRAINT IPAGTD003_TIPO_OPERACAO_UK01 UNIQUE (CO_TIPO_OPERACAO)
);

COMMENT ON TABLE IPAGTD003_TIPO_OPERACAO IS
...
COMMENT ON COLUMN IPAGTD003_TIPO_OPERACAO.ID_TIPO_OPERACAO     IS 'Identificador surrogate gerado por sequence.';
COMMENT ON COLUMN IPAGTD003_TIPO_OPERACAO.CO_TIPO_OPERACAO     IS 'Codigo da operacao. Campo G028. Valores: C=Credito, D=Debito, E=Extrato Conciliacao.';
COMMENT ON COLUMN IPAGTD003_TIPO_OPERACAO.NO_TIPO_OPERACAO     IS 'Descricao da operacao. Exemplo: Credito em Conta Corrente.';
COMMENT ON COLUMN IPAGTD003_TIPO_OPERACAO.DH_INCLUSAO          IS 'Data e hora de inclusao.';
COMMENT ON COLUMN IPAGTD003_TIPO_OPERACAO.DH_ALTERACAO         IS 'Data e hora da ultima alteracao.';
COMMENT ON COLUMN IPAGTD003_TIPO_OPERACAO.NO_USUARIO_INCLUSAO  IS 'Login do usuario que incluiu.';
COMMENT ON COLUMN IPAGTD003_TIPO_OPERACAO.NO_USUARIO_ALTERACAO IS 'Login do usuario que alterou.';

-- ----------------------------------------------------------------------------
-- IPAGTD004_TIPO_MOVIMENTO
-- ----------------------------------------------------------------------------
CREATE SEQUENCE IPAGTD004_TIPO_MOVIMENTO_SQ START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE IPAGTD004_TIPO_MOVIMENTO (
    ID_TIPO_MOVIMENTO      NUMBER          DEFAULT ON NULL IPAGTD004_TIPO_MOVIMENTO_SQ.NEXTVAL,
    ...
    NO_USUARIO_INCLUSAO    VARCHAR2(60)    NOT NULL,
    NO_USUARIO_ALTERACAO   VARCHAR2(60),
    CONSTRAINT IPAGTD004_TIPO_MOVIMENTO_PK   PRIMARY KEY (ID_TIPO_MOVIMENTO),
    CONSTRAINT IPAGTD004_TIPO_MOVIMENTO_UK01 UNIQUE (CO_TIPO_MOVIMENTO)
);

COMMENT ON TABLE IPAGTD004_TIPO_MOVIMENTO IS
...
COMMENT ON COLUMN IPAGTD004_TIPO_MOVIMENTO.ID_TIPO_MOVIMENTO     IS 'Identificador surrogate gerado por sequence.';
COMMENT ON COLUMN IPAGTD004_TIPO_MOVIMENTO.CO_TIPO_MOVIMENTO     IS 'Codigo do tipo de movimento. Campo G060. Exemplos: 0=Inclusao, 5=Alteracao, 9=Exclusao.';
COMMENT ON COLUMN IPAGTD004_TIPO_MOVIMENTO.NO_TIPO_MOVIMENTO     IS 'Descricao do tipo de movimento.';
COMMENT ON COLUMN IPAGTD004_TIPO_MOVIMENTO.DH_INCLUSAO           IS 'Data e hora de inclusao.';
COMMENT ON COLUMN IPAGTD004_TIPO_MOVIMENTO.DH_ALTERACAO          IS 'Data e hora da ultima alteracao.';
COMMENT ON COLUMN IPAGTD004_TIPO_MOVIMENTO.NO_USUARIO_INCLUSAO   IS 'Login do usuario que incluiu.';
COMMENT ON COLUMN IPAGTD004_TIPO_MOVIMENTO.NO_USUARIO_ALTERACAO  IS 'Login do usuario que alterou.';

-- ----------------------------------------------------------------------------
-- IPAGTD005_TIPO_INSCRICAO
-- ----------------------------------------------------------------------------
CREATE SEQUENCE IPAGTD005_TIPO_INSCRICAO_SQ START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE IPAGTD005_TIPO_INSCRICAO (
    ID_TIPO_INSCRICAO      NUMBER          DEFAULT ON NULL IPAGTD005_TIPO_INSCRICAO_SQ.NEXTVAL,
    ...
    NO_USUARIO_INCLUSAO    VARCHAR2(60)    NOT NULL,
    NO_USUARIO_ALTERACAO   VARCHAR2(60),
    CONSTRAINT IPAGTD005_TIPO_INSCRICAO_PK   PRIMARY KEY (ID_TIPO_INSCRICAO),
    CONSTRAINT IPAGTD005_TIPO_INSCRICAO_UK01 UNIQUE (CO_TIPO_INSCRICAO)
);

COMMENT ON TABLE IPAGTD005_TIPO_INSCRICAO IS
...
COMMENT ON COLUMN IPAGTD005_TIPO_INSCRICAO.ID_TIPO_INSCRICAO     IS 'Identificador surrogate gerado por sequence.';
COMMENT ON COLUMN IPAGTD005_TIPO_INSCRICAO.CO_TIPO_INSCRICAO     IS 'Codigo do tipo de inscricao. Campo G005. Valores: 1=CPF, 2=CNPJ.';
COMMENT ON COLUMN IPAGTD005_TIPO_INSCRICAO.NO_TIPO_INSCRICAO     IS 'Descricao do tipo de inscricao. Exemplo: CNPJ - Cadastro Nacional de Pessoa Juridica.';
COMMENT ON COLUMN IPAGTD005_TIPO_INSCRICAO.DH_INCLUSAO           IS 'Data e hora de inclusao.';
COMMENT ON COLUMN IPAGTD005_TIPO_INSCRICAO.DH_ALTERACAO          IS 'Data e hora da ultima alteracao.';
COMMENT ON COLUMN IPAGTD005_TIPO_INSCRICAO.NO_USUARIO_INCLUSAO   IS 'Login do usuario que incluiu.';
COMMENT ON COLUMN IPAGTD005_TIPO_INSCRICAO.NO_USUARIO_ALTERACAO  IS 'Login do usuario que alterou.';

-- ----------------------------------------------------------------------------
-- IPAGTD006_TIPO_MOEDA
-- ----------------------------------------------------------------------------
CREATE SEQUENCE IPAGTD006_TIPO_MOEDA_SQ START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE IPAGTD006_TIPO_MOEDA (
    ID_TIPO_MOEDA          NUMBER          DEFAULT ON NULL IPAGTD006_TIPO_MOEDA_SQ.NEXTVAL,
    ...
    NO_USUARIO_INCLUSAO    VARCHAR2(60)    NOT NULL,
    NO_USUARIO_ALTERACAO   VARCHAR2(60),
    CONSTRAINT IPAGTD006_TIPO_MOEDA_PK   PRIMARY KEY (ID_TIPO_MOEDA),
    CONSTRAINT IPAGTD006_TIPO_MOEDA_UK01 UNIQUE (CO_TIPO_MOEDA)
);

COMMENT ON TABLE IPAGTD006_TIPO_MOEDA IS
...
COMMENT ON COLUMN IPAGTD006_TIPO_MOEDA.ID_TIPO_MOEDA          IS 'Identificador surrogate gerado por sequence.';
COMMENT ON COLUMN IPAGTD006_TIPO_MOEDA.CO_TIPO_MOEDA          IS 'Sigla ISO 4217 da moeda. Campo G040. Exemplo: BRL, USD.';
COMMENT ON COLUMN IPAGTD006_TIPO_MOEDA.NO_TIPO_MOEDA          IS 'Nome completo da moeda. Exemplo: Real Brasileiro.';
COMMENT ON COLUMN IPAGTD006_TIPO_MOEDA.DH_INCLUSAO            IS 'Data e hora de inclusao.';
COMMENT ON COLUMN IPAGTD006_TIPO_MOEDA.DH_ALTERACAO           IS 'Data e hora da ultima alteracao.';
COMMENT ON COLUMN IPAGTD006_TIPO_MOEDA.NO_USUARIO_INCLUSAO    IS 'Login do usuario que incluiu.';
COMMENT ON COLUMN IPAGTD006_TIPO_MOEDA.NO_USUARIO_ALTERACAO   IS 'Login do usuario que alterou.';

-- ----------------------------------------------------------------------------
-- IPAGTD007_CAMARA_CENTRAL
-- ----------------------------------------------------------------------------
CREATE SEQUENCE IPAGTD007_CAMARA_CENTRAL_SQ START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE IPAGTD007_CAMARA_CENTRAL (
    ID_CAMARA_CENTRALIZADORA   NUMBER        DEFAULT ON NULL IPAGTD007_CAMARA_CENTRAL_SQ.NEXTVAL,
    ...
    NO_USUARIO_INCLUSAO        VARCHAR2(60)  NOT NULL,
    NO_USUARIO_ALTERACAO       VARCHAR2(60),
    CONSTRAINT IPAGTD007_CAMARA_CENTRAL_PK   PRIMARY KEY (ID_CAMARA_CENTRALIZADORA),
    CONSTRAINT IPAGTD007_CAMARA_CENTRAL_UK01 UNIQUE (NU_CAMARA_CENTRALIZADORA)
);

COMMENT ON TABLE IPAGTD007_CAMARA_CENTRAL IS
...
COMMENT ON COLUMN IPAGTD007_CAMARA_CENTRAL.ID_CAMARA_CENTRALIZADORA  IS 'Identificador surrogate gerado por sequence.';
COMMENT ON COLUMN IPAGTD007_CAMARA_CENTRAL.NU_CAMARA_CENTRALIZADORA  IS 'Codigo numerico de 3 digitos da camara. Campo P001. Exemplos: 000=CC/TED, 988=PIX.';
COMMENT ON COLUMN IPAGTD007_CAMARA_CENTRAL.NO_CAMARA_CENTRALIZADORA  IS 'Descricao da camara centralizadora. Exemplo: PIX - Sistema de Pagamentos Instantaneos.';
COMMENT ON COLUMN IPAGTD007_CAMARA_CENTRAL.DH_INCLUSAO               IS 'Data e hora de inclusao.';
COMMENT ON COLUMN IPAGTD007_CAMARA_CENTRAL.DH_ALTERACAO              IS 'Data e hora da ultima alteracao.';
COMMENT ON COLUMN IPAGTD007_CAMARA_CENTRAL.NO_USUARIO_INCLUSAO       IS 'Login do usuario que incluiu.';
COMMENT ON COLUMN IPAGTD007_CAMARA_CENTRAL.NO_USUARIO_ALTERACAO      IS 'Login do usuario que alterou.';
...
INSERT INTO IPAGTD001_TIPO_REGISTRO (CO_TIPO_REGISTRO, NO_TIPO_REGISTRO, NO_USUARIO_INCLUSAO)
...
INSERT INTO IPAGTD002_TIPO_SERVICO (CO_TIPO_SERVICO, NO_TIPO_SERVICO, NO_USUARIO_INCLUSAO)
...
INSERT INTO IPAGTD003_TIPO_OPERACAO (CO_TIPO_OPERACAO, NO_TIPO_OPERACAO, NO_USUARIO_INCLUSAO)
...
INSERT INTO IPAGTD004_TIPO_MOVIMENTO (CO_TIPO_MOVIMENTO, NO_TIPO_MOVIMENTO, NO_USUARIO_INCLUSAO)
...
INSERT INTO IPAGTD005_TIPO_INSCRICAO (CO_TIPO_INSCRICAO, NO_TIPO_INSCRICAO, NO_USUARIO_INCLUSAO)
...
INSERT INTO IPAGTD006_TIPO_MOEDA (CO_TIPO_MOEDA, NO_TIPO_MOEDA, NO_USUARIO_INCLUSAO)
...
INSERT INTO IPAGTD007_CAMARA_CENTRAL (NU_CAMARA_CENTRALIZADORA, NO_CAMARA_CENTRALIZADORA, NO_USUARIO_INCLUSAO)
...
CREATE TABLE IPAGTB002_HEADER_ARQUIVO (
    ...
    CONSTRAINT IPAGTB002_IPAGTB001_FK01
        FOREIGN KEY (ID_ARQUIVO) REFERENCES IPAGTB001_ARQUIVO (ID_ARQUIVO),
    CONSTRAINT IPAGTB002_IPAGTD005_FK01
        FOREIGN KEY (ID_TIPO_INSCRICAO) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO),
...
CREATE TABLE IPAGTB003_TRAILER_ARQUIVO (
    ...
    CONSTRAINT IPAGTB003_IPAGTB001_FK01
        FOREIGN KEY (ID_ARQUIVO) REFERENCES IPAGTB001_ARQUIVO (ID_ARQUIVO)
);
...
CREATE TABLE IPAGTB004_LOTE (
    ...
    CONSTRAINT IPAGTB004_IPAGTB001_FK01
        FOREIGN KEY (ID_ARQUIVO) REFERENCES IPAGTB001_ARQUIVO (ID_ARQUIVO),
    CONSTRAINT IPAGTB004_IPAGTD002_FK01
        FOREIGN KEY (ID_TIPO_SERVICO) REFERENCES IPAGTD002_TIPO_SERVICO (ID_TIPO_SERVICO),
    CONSTRAINT IPAGTB004_IPAGTD003_FK01
        FOREIGN KEY (ID_TIPO_OPERACAO) REFERENCES IPAGTD003_TIPO_OPERACAO (ID_TIPO_OPERACAO),
...
CREATE TABLE IPAGTB005_HEADER_LOTE (
    ...
    CONSTRAINT IPAGTB005_IPAGTB004_FK01
        FOREIGN KEY (ID_LOTE) REFERENCES IPAGTB004_LOTE (ID_LOTE),
    CONSTRAINT IPAGTB005_IPAGTD005_FK01
        FOREIGN KEY (ID_TIPO_INSCRICAO) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO),
...
CREATE TABLE IPAGTB006_TRAILER_LOTE (
    ...
    CONSTRAINT IPAGTB006_IPAGTB004_FK01
        FOREIGN KEY (ID_LOTE) REFERENCES IPAGTB004_LOTE (ID_LOTE)
);
...
CREATE TABLE IPAGTB007_DETALHE_REG (
    ...
    CONSTRAINT IPAGTB007_IPAGTB004_FK01
        FOREIGN KEY (ID_LOTE) REFERENCES IPAGTB004_LOTE (ID_LOTE),
    CONSTRAINT IPAGTB007_IPAGTD004_FK01
        FOREIGN KEY (ID_TIPO_MOVIMENTO) REFERENCES IPAGTD004_TIPO_MOVIMENTO (ID_TIPO_MOVIMENTO)
);
...
CREATE TABLE IPAGTB010_DET_PAGAMENTO (
    ...
    CONSTRAINT IPAGTB010_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG),
    CONSTRAINT IPAGTB010_IPAGTD006_FK01
        FOREIGN KEY (ID_TIPO_MOEDA) REFERENCES IPAGTD006_TIPO_MOEDA (ID_TIPO_MOEDA),
    CONSTRAINT IPAGTB010_IPAGTD007_FK01
        FOREIGN KEY (ID_CAMARA_CENTRALIZADORA) REFERENCES IPAGTD007_CAMARA_CENTRAL (ID_CAMARA_CENTRALIZADORA)
);
...
CREATE TABLE IPAGTB011_DET_INFO_FAVORECIDO (
    ...
    CONSTRAINT IPAGTB011_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG),
    CONSTRAINT IPAGTB011_IPAGTD005_FK01
        FOREIGN KEY (ID_TIPO_INSCRICAO) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO)
);
...
CREATE TABLE IPAGTB012_DET_COMPLEMENTAR (
    ...
    CONSTRAINT IPAGTB012_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG)
);
...
CREATE TABLE IPAGTB013_DET_TITULO_COBRANCA (
    ...
    CONSTRAINT IPAGTB013_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG)
);
...
CREATE TABLE IPAGTB014_DET_PARTES_TITULO (
    ...
    CONSTRAINT IPAGTB014_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG),
    CONSTRAINT IPAGTB014_IPAGTD005_FK01
        FOREIGN KEY (ID_TIPO_INSCRICAO_PAGADOR) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO),
    CONSTRAINT IPAGTB014_IPAGTD005_FK02
        FOREIGN KEY (ID_TIPO_INSCRICAO_BENEF) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO),
    CONSTRAINT IPAGTB014_IPAGTD005_FK03
        FOREIGN KEY (ID_TIPO_INSCRICAO_SACADOR) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO)
);
...
CREATE TABLE IPAGTB015_DET_PIX_QR_CODE (
    ...
    CONSTRAINT IPAGTB015_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG),
    CONSTRAINT IPAGTB015_IPAGTD005_FK01
        FOREIGN KEY (ID_TIPO_INSCRICAO_DEVEDOR) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO),
    CONSTRAINT IPAGTB015_IPAGTD005_FK02
        FOREIGN KEY (ID_TIPO_INSCRICAO_FAVO) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO)
);
...
CREATE TABLE IPAGTB016_DET_TRIBUTO_SEM_CB (
    ...
    CONSTRAINT IPAGTB016_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG)
);
...
CREATE TABLE IPAGTB017_DET_TRIBUTO_COM_CB (
    ...
    CONSTRAINT IPAGTB017_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG)
);
...
CREATE TABLE IPAGTB018_DET_COMPL_TRIBUTO (
    ...
    CONSTRAINT IPAGTB018_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG)
);
...
CREATE TABLE IPAGTB019_DET_IDENT_TRIBUTO (
    ...
    CONSTRAINT IPAGTB019_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG)
);
...
CREATE TABLE IPAGTB020_DET_DADOS_TITULO (
    ...
    CONSTRAINT IPAGTB020_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG),
    CONSTRAINT IPAGTB020_IPAGTD005_FK01
        FOREIGN KEY (ID_TIPO_INSCRICAO_SACADO) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO)
);
...
CREATE TABLE IPAGTB021_DET_DADOS_SACADO (
    ...
    CONSTRAINT IPAGTB021_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG),
    CONSTRAINT IPAGTB021_IPAGTD005_FK01
        FOREIGN KEY (ID_TIPO_INSCRICAO_SACADO) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO),
    CONSTRAINT IPAGTB021_IPAGTD005_FK02
        FOREIGN KEY (ID_TIPO_INSCRICAO_SACADOR) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO)
);
...
CREATE TABLE IPAGTB022_DET_DESCONTO_TITULO (
    ...
    CONSTRAINT IPAGTB022_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG)
);
...
CREATE TABLE IPAGTB023_DET_RETORNO_TITULO (
    ...
    CONSTRAINT IPAGTB023_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG),
    CONSTRAINT IPAGTB023_IPAGTD005_FK01
        FOREIGN KEY (ID_TIPO_INSCRICAO_SACADO) REFERENCES IPAGTD005_TIPO_INSCRICAO (ID_TIPO_INSCRICAO)
);
...
CREATE TABLE IPAGTB024_DET_COMPL_RETORNO (
    ...
    CONSTRAINT IPAGTB024_IPAGTB007_FK01
        FOREIGN KEY (ID_DETALHE_REG) REFERENCES IPAGTB007_DETALHE_REG (ID_DETALHE_REG)
);
...
--   Tabelas de dominio : 7  (IPAGTD001-007)
...
--   * IPAGTD008_SERVICO_DESTINO  - dominio dos servicos de destino
...
--   * ALTER em IPAGTD002_TIPO_SERVICO - FK para servico de destino
--   * IPAGTV001_STATUS_ARQUIVO   - view de monitoramento de arquivos
--   * IPAGTV002_DISPATCH_PENDENTE - fila de trabalho para workers
-- =============================================================================

-- =============================================================================
-- DOMINIO: IPAGTD008_SERVICO_DESTINO
-- =============================================================================
CREATE SEQUENCE IPAGTD008_SERVICO_DESTINO_SQ START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE IPAGTD008_SERVICO_DESTINO (
    ID_SERVICO_DESTINO   NUMBER        DEFAULT ON NULL IPAGTD008_SERVICO_DESTINO_SQ.NEXTVAL,
    ...
    NO_USUARIO_INCLUSAO  VARCHAR2(60)  NOT NULL,
    NO_USUARIO_ALTERACAO VARCHAR2(60),
    CONSTRAINT IPAGTD008_SERVICO_DESTINO_PK   PRIMARY KEY (ID_SERVICO_DESTINO),
    CONSTRAINT IPAGTD008_SERVICO_DESTINO_UK01 UNIQUE (CO_SERVICO),
    CONSTRAINT IPAGTD008_SERVICO_DESTINO_IN_ATIVO_CK01
        CHECK (IN_ATIVO IN ('S','N'))
);

COMMENT ON TABLE IPAGTD008_SERVICO_DESTINO IS
...
-- =============================================================================
-- ALTER IPAGTD002_TIPO_SERVICO: FK para servico de destino (coluna ja inline na CREATE TABLE)
-- =============================================================================
COMMENT ON COLUMN IPAGTD002_TIPO_SERVICO.ID_SERVICO_DESTINO IS
    'FK para IPAGTD008_SERVICO_DESTINO. Indica qual microsservico e responsavel '
...
ALTER TABLE IPAGTD002_TIPO_SERVICO
    ADD CONSTRAINT IPAGTD002_IPAGTD008_FK01
        FOREIGN KEY (ID_SERVICO_DESTINO)
        REFERENCES IPAGTD008_SERVICO_DESTINO (ID_SERVICO_DESTINO);

-- Mapeamento inicial: tipos de servico -> servico de destino
-- Cobranca e Boleto -> BOLETO
UPDATE IPAGTD002_TIPO_SERVICO
   SET ID_SERVICO_DESTINO = (SELECT ID_SERVICO_DESTINO FROM IPAGTD008_SERVICO_DESTINO WHERE CO_SERVICO = 'BOLETO')
 WHERE CO_TIPO_SERVICO IN ('01','03');

-- Pagamentos, Salarios, Vendor, Compror, Debito -> PAGAMENTO
UPDATE IPAGTD002_TIPO_SERVICO
   SET ID_SERVICO_DESTINO = (SELECT ID_SERVICO_DESTINO FROM IPAGTD008_SERVICO_DESTINO WHERE CO_SERVICO = 'PAGAMENTO')
 WHERE CO_TIPO_SERVICO IN ('20','22','25','30','50','60','98');

-- Tributos (com e sem CB), GPS -> TRIBUTO
UPDATE IPAGTD002_TIPO_SERVICO
   SET ID_SERVICO_DESTINO = (SELECT ID_SERVICO_DESTINO FROM IPAGTD008_SERVICO_DESTINO WHERE CO_SERVICO = 'TRIBUTO')
...
CREATE TABLE IPAGTB025_CONTROLE_CARGA (
    ...
    CONSTRAINT IPAGTB025_IPAGTB001_FK01
        FOREIGN KEY (ID_ARQUIVO) REFERENCES IPAGTB001_ARQUIVO (ID_ARQUIVO),
    CONSTRAINT IPAGTB025_IPAGTB004_FK01
...
CREATE TABLE IPAGTB027_DISPATCH_LOTE (
    ...
    CONSTRAINT IPAGTB027_IPAGTB004_FK01
        FOREIGN KEY (ID_LOTE) REFERENCES IPAGTB004_LOTE (ID_LOTE),
    CONSTRAINT IPAGTB027_IPAGTD008_FK01
        FOREIGN KEY (ID_SERVICO_DESTINO) REFERENCES IPAGTD008_SERVICO_DESTINO (ID_SERVICO_DESTINO),
...
COMMENT ON COLUMN IPAGTB027_DISPATCH_LOTE.ID_SERVICO_DESTINO IS
    'FK para IPAGTD008_SERVICO_DESTINO. Servico que deve receber este lote (BOLETO, PAGAMENTO ou TRIBUTO).';
...
COMMENT ON COLUMN IPAGTB027_DISPATCH_LOTE.NU_MAX_TENTATIVA IS
    'Numero maximo de tentativas para este dispatch. Copiado de IPAGTD008_SERVICO_DESTINO no momento da criacao.';
...
CREATE TABLE IPAGTB028_HISTORICO_DISPATCH (
    ...
    CONSTRAINT IPAGTB028_IPAGTB027_FK01
...
FROM
    ...
    LEFT JOIN IPAGTD008_SERVICO_DESTINO  sd  ON sd.ID_SERVICO_DESTINO = dl.ID_SERVICO_DESTINO
GROUP BY
    arq.ID_ARQUIVO,
    arq.NO_NOME_ARQUIVO,
    arq.NU_BANCO_COMPENSACAO,
...
FROM
    ...
    JOIN IPAGTD002_TIPO_SERVICO  ts  ON ts.ID_TIPO_SERVICO      = lt.ID_TIPO_SERVICO
    JOIN IPAGTD008_SERVICO_DESTINO sd ON sd.ID_SERVICO_DESTINO  = dl.ID_SERVICO_DESTINO
WHERE
...
CREATE TABLE IPAGTB029_CONTROLE_LINHA (
    ...
    CONSTRAINT IPAGTB029_IPAGTB001_FK01
        FOREIGN KEY (ID_ARQUIVO) REFERENCES IPAGTB001_ARQUIVO (ID_ARQUIVO),
    CONSTRAINT IPAGTB029_IPAGTD001_FK01
        FOREIGN KEY (ID_TIPO_REGISTRO) REFERENCES IPAGTD001_TIPO_REGISTRO (ID_TIPO_REGISTRO),
...
-- =============================================================================
-- CORRECOES DO MODELO: FKs para tabelas de dominio (IPAGTD001 a IPAGTD007)
...
COMMENT ON COLUMN IPAGTB004_LOTE.ID_TIPO_SERVICO IS
    'FK para IPAGTD002_TIPO_SERVICO. Resolve o codigo bruto CO_TIPO_SERVICO (campo G025 do CNAB240) '
    'para o registro de dominio correspondente, permitindo rastreabilidade ate o servico de destino '
    '(IPAGTD008_SERVICO_DESTINO) via IPAGTD002.ID_SERVICO_DESTINO. Preenchido apos lookup por CO_TIPO_SERVICO.';
COMMENT ON COLUMN IPAGTB004_LOTE.ID_TIPO_OPERACAO IS
    'FK para IPAGTD003_TIPO_OPERACAO. Resolve o codigo bruto CO_TIPO_OPERACAO (campo G028) '
...
COMMENT ON COLUMN IPAGTB007_DETALHE_REG.ID_TIPO_MOVIMENTO IS
    'FK para IPAGTD004_TIPO_MOVIMENTO. Resolve o codigo bruto CO_TIPO_MOVIMENTO (campo G060) '
...
COMMENT ON COLUMN IPAGTB002_HEADER_ARQUIVO.ID_TIPO_INSCRICAO IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_EMPRESA (campo G005, posicao 18 do CNAB240) '
...
COMMENT ON COLUMN IPAGTB005_HEADER_LOTE.ID_TIPO_INSCRICAO IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_EMPRESA (posicoes 18 do header de lote) '
...
COMMENT ON COLUMN IPAGTB010_DET_PAGAMENTO.ID_TIPO_MOEDA IS
    'FK para IPAGTD006_TIPO_MOEDA. Resolve CO_TIPO_MOEDA (campo G040, ex: BRL, USD) '
...
COMMENT ON COLUMN IPAGTB010_DET_PAGAMENTO.ID_CAMARA_CENTRALIZADORA IS
    'FK para IPAGTD007_CAMARA_CENTRAL. Resolve NU_CAMARA_CENTRALIZADORA (campo G029, '
...
COMMENT ON COLUMN IPAGTB011_DET_INFO_FAVORECIDO.ID_TIPO_INSCRICAO IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_FAVO (tipo de inscricao do favorecido '
...
COMMENT ON COLUMN IPAGTB014_DET_PARTES_TITULO.ID_TIPO_INSCRICAO_PAGADOR IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_PAGADOR (Segmento J-52) '
...
COMMENT ON COLUMN IPAGTB014_DET_PARTES_TITULO.ID_TIPO_INSCRICAO_BENEF IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_BENEF (Segmento J-52) '
...
COMMENT ON COLUMN IPAGTB014_DET_PARTES_TITULO.ID_TIPO_INSCRICAO_SACADOR IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_SACADOR (Segmento J-52) '
...
COMMENT ON COLUMN IPAGTB015_DET_PIX_QR_CODE.ID_TIPO_INSCRICAO_DEVEDOR IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_DEVEDOR (Segmento J-52 PIX) '
...
COMMENT ON COLUMN IPAGTB015_DET_PIX_QR_CODE.ID_TIPO_INSCRICAO_FAVO IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_FAVO (Segmento J-52 PIX) '
...
COMMENT ON COLUMN IPAGTB020_DET_DADOS_TITULO.ID_TIPO_INSCRICAO_SACADO IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_SACADO (Segmento P de cobranca) '
...
COMMENT ON COLUMN IPAGTB021_DET_DADOS_SACADO.ID_TIPO_INSCRICAO_SACADO IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_SACADO (Segmento Q de cobranca) '
...
COMMENT ON COLUMN IPAGTB021_DET_DADOS_SACADO.ID_TIPO_INSCRICAO_SACADOR IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_SACADOR (Segmento Q de cobranca) '
...
COMMENT ON COLUMN IPAGTB023_DET_RETORNO_TITULO.ID_TIPO_INSCRICAO_SACADO IS
    'FK para IPAGTD005_TIPO_INSCRICAO. Resolve CO_TIPO_INSCRICAO_SACADO (Segmento T de retorno cobranca) '
...
COMMENT ON COLUMN IPAGTB029_CONTROLE_LINHA.ID_TIPO_REGISTRO IS
    'FK para IPAGTD001_TIPO_REGISTRO. Resolve CO_TIPO_REGISTRO (posicao 8 da linha CNAB240) para '
